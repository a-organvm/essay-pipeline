...
Run: `organvm ecosystem show essay-pipeline` | `organvm ecosystem validate --organ V`


## Task Queue (from pipeline)

**24** pending tasks | Last pipeline: unknown

- `c5a9b8a19a8c` 1a. Make `references` required in essay schema [bash, jekyll, pytest]
- `dd30fe2cdf50` 1b. Add `references` to log schema [bash, jekyll, pytest]
- `9cc4e4d8e8ba` 1c. Restructure log template [bash, jekyll, pytest]
- `7e902b040dd9` 1d. Add citation guidance to 5 essay templates [bash, jekyll, pytest]
- `9d493c4371b5` 2a. Restructure `build_scaffold()` in log_generator.py [bash, jekyll, pytest]
- `8699a73206eb` 2b. Update tests [bash, jekyll, pytest]
- `24f3a5dda52e` 3a. Add references to log layout [bash, jekyll, pytest]
- `4d1de2e529fe` 3b. Add anchor IDs to references partial [bash, jekyll, pytest]
- ... and 16 more
